    ...
    while (!WindowShouldClose()) {
        ...
        if (IsKeyPressed(KEY_SPACE)) {
            ...
            if (bolas != NULL) {
                ...
                nova -> vel = (Vector2){ (float)GetRandomValue(-4, 4), (float)GetRandomValue(-4, 4) };
        ...
        BeginDrawing();
            ...
            DrawText(TextFormat("Bolas: %d | Visitadas: %d", quantidadeBolas, celulasVisitadas), 10, 35, 16, WHITE);
